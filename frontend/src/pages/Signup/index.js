      ...
      <Container maxWidth="lg" className={classes.container}>
        ...
        <div className={classes.hero}>
          ...
          <Typography variant="h6" className={classes.heroSubtitle}>
            Prueba gratuitamente durante {trial} días todas las funcionalidades  
                  ...
                  {selectedPlan && (
                    <div className={classes.planSummary}>
                      <Typography variant="body1">
                        Plan selecionado: <span className={classes.planName}>{selectedPlan.name}</span>
                      </Typography>
                      <Typography variant="body1" fontWeight="600">
                        $ {selectedPlan.value.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}/mes
                      </Typography>
                    </div>
                  )}
                        ...
                        <Grid container spacing={3}>
                          ...
                          <Grid item xs={12}>
                            <Field
                              ...
                              autoComplete="name"
                              name="name"
                              error={touched.name && Boolean(errors.name)} // Muestra error si el campo fue tocado y tiene error
                              helperText={touched.name && errors.name}     // Texto de ayuda para el error
                              variant="outlined"
                              fullWidth
                              id="name"
