...
import { TbBrandFacebookFilled, TbBrandInstagram, TbMessageChatbot } from "react-icons/tb";
...
const useStyles = makeStyles(theme => ({
  ...
  instagram: {
    backgroundColor: "#E1306C", // Rosa Instagram
  },
  facebook: {
    backgroundColor: "#3b5998", // Azul Facebook
  },
  webchat: {
    backgroundColor: "#3065E1", // Verde Webchat
  },
  whatsapp: {
    backgroundColor: "#25D366", // Verde WhatsApp
  },
  telegram: {
    backgroundColor: "#229ED9", // Azul Telegram
  },
  sms: {
    backgroundColor: "#607D8B", // Gris SMS
  },
  email: {
    backgroundColor: "#D44638", // Rojo Gmail
  }
}));
    ...
    <Box display="flex" alignItems="center" mb={2}>
      ...
      <LinearProgress 
        ...
        style={{ 
          ...
          // Aplica color al "bar" directamente
          '--MuiLinearProgress-barColorPrimary': statusData.class.includes("connected") 
            ? green[600]
            : statusData.class.includes("disconnected")
              ? red[600]
              : blue[600]
        }}
      />
      ...
      <>
        ...
        {(whatsApp.status === "CONNECTED" ||
          ...
          <Button
            ...
            disabled={whatsApp.type !== "Whatsapp"}
            fullWidth
          >
                      ...
                      <Box className={classes.cardHeader}>
                        <Box display="flex" alignItems="center" minWidth={0}>
                          <Avatar   className={clsx(classes.avatar, {
                            [classes.instagram]: whatsApp.type === "Instagram",
                            [classes.facebook]: whatsApp.type === "Facebook",
                            [classes.webchat]: whatsApp.type === "Webchat",
                            [classes.whatsapp]: whatsApp.type === "Whatsapp",
                            [classes.telegram]: whatsApp.type === "Telegram",
                            [classes.sms]: whatsApp.type === "Sms",
                            [classes.email]: whatsApp.type === "Email",
                          })}> 
                            {whatsApp.type === "Instagram" ? (
                              <TbBrandInstagram size={24} />
                            ) : whatsApp.type === "Facebook" ? (
                              <TbBrandFacebookFilled size={24} />
