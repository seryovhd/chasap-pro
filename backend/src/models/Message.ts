...
import { BeforeCreate, BeforeUpdate } from "sequelize-typescript";
...
class Message extends Model<Message> {
  ...
  @BeforeCreate
  @BeforeUpdate
  static setDefaultBodyIfNull(instance: Message) {
    if (instance.body === null || instance.body === undefined) {
      instance.body = "*Este mensaje fue eliminado*";
    }
  }
}
